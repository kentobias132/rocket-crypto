...
function AboutUs() {
  return (
    <div className="relative">
      <img
        src="/Graphic2.png"
        className="absolute top-0 right-0 object-contain -z-10 opacity-50"
        alt=""
      />
      <div className="container px4 mx-auto font-sans">
        <div
          data-aos="zoom-in-down"
          className="flex py-8 flex-col md:flex-row justify-between items-center"
        >
          ...
          <div
            ...
            className=" flex flex-col px-4 md:px-8 justify-center md:w-1/2"
          >
        ...
        <div data-aos="zoom-out-up" className="text-center py-16 px-4">
